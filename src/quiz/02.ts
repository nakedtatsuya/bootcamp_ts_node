...
type FuncType = /* ここに定義を書く */ (x: number) => number;

// ここのエラーを解消する
const addOne: FuncType = (x: number): number => x + 1;

// Q: SumFunc という型を定義して、エラーを解消してください。
type SumFunc = /* ここに定義を書く */ (x: number[]) => number;
...
type Array2 = /* 定義を書く */ Array<number | string>;
...
type Tuple1 = /* 定義を書く */ [number, string];
